...
const demos = [
  {
    ...
    borderColor: 'rgba(91,110,245,0.25)',
  ...
  },
  {
    ...
    borderColor: 'rgba(236,178,46,0.15)',
    ...
    <section className="py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2
            className="font-bricolage font-extrabold text-white text-2xl md:text-4xl"
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex-1">
                  <h3
                    className="font-bricolage font-bold text-white text-xl mb-2"
