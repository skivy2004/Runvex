import StatsBar from '../dashboard/components/StatsBar'
import LeadSourceCard from '../dashboard/components/LeadSourceCard'
import ActivityFeed from '../dashboard/components/ActivityFeed'
import LeadChart from '../dashboard/components/LeadChart'
import DemoLeadTable from './DemoLeadTable'
import { DEMO_LEADS } from '../dashboard/demo-data'
    ...
    <div>
      ...
      <div className="flex items-start justify-between mb-6 gap-4">
        ...
        <a
          ...
          style={{ border: '1.5px dashed rgba(91,110,245,0.4)', background: 'rgba(91,110,245,0.06)' }}
        >
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs mt-0.5" style={{ color: '#5A5E82' }}>{leads.length} voorbeeldleads</p>
          </div>
        </div>
        <DemoLeadTable leads={leads} />
      </div>
    </div>
  )
}
